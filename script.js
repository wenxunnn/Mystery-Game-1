...
const HINTS = {
  clue1: "The lock is measuring the numerals before it reads them. A five-character answer may not be larger than a four-character answer.",
  ...
  clue3: "A reliable log can make an unreliable memory look very specific. Line up the clock before judging the story.",
  clue4: "The printed summary is tidy. The raw ledger remembers what was changed.",
};
...
const CHECKERS = {
  ...
  clue2: function (raw) {
    // Intended physical-prop path:
    // Case month = June. Physical field guide gives June cooling rate = 1.00 °C/hour.
    // Normal body temperature 37.0 °C - exam temperature 30.0 °C = 7.0 °C drop.
    // 7.0 hours before the 11:00 PM examination = 4:00 PM.
